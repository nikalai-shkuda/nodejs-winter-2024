export enum errorMessages {
  ...
  ALBUM_REQUIRED_PARAM = 'Name and year are required',
  ARTIST_NOT_FOUND = 'Artist has not been found',
  ARTIST_REQUIRED_PARAM = 'Grammy and name are required',
  TRACK_NOT_FOUND = 'Track has not been found',
  TRACK_REQUIRED_PARAM = 'Duration and name are required',
  USER_ALREADY_EXISTS = 'User already exists',
  USER_NOT_FOUND = 'User has not been found',
  USER_REQUIRED_PARAM = 'Login and password are required',
